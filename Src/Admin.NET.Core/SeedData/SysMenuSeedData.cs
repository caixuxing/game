...
public class SysMenuSeedData : ISqlSugarEntitySeedData<SysMenu>
{
    ...
    public IEnumerable<SysMenu> HasData()
    {
        return new[]
        {
            ...
            new SysMenu{ Id=1310000000901, Pid=0, Title="财务管理", Path="/finance", Name="finance", Component="Layout", Icon="ele-Menu", Type=MenuTypeEnum.Dir, CreateTime=DateTime.Parse("2023-03-12 00:00:00"), OrderNo=16000 },
            new SysMenu{ Id=1310000000911, Pid=1310000000901, Title="币种汇率配置管理", Path="/finance/currencyRateConfig", Name="sysCurrencyRateConfig", Component="/finance/currencyRateConfig/index",Icon="ele-Setting", Type=MenuTypeEnum.Menu, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000000912, Pid=1310000000911, Title="查询", Permission="currencyRateConfig:page", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000000913, Pid=1310000000911, Title="编辑", Permission="currencyRateConfig:update", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000000914, Pid=1310000000911, Title="增加", Permission="currencyRateConfig:add", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000000915, Pid=1310000000911, Title="删除", Permission="currencyRateConfig:delete", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
            new SysMenu{ Id=1310000000916, Pid=1310000000911, Title="同步设置", Permission="currencyRateConfig:sync", Type=MenuTypeEnum.Btn, CreateTime=DateTime.Parse("2022-02-10 00:00:00"), OrderNo=100 },
        };
    }
}